...
- 学习资源：备考建议、命题趋势
- 国际局势：包含美国、英国、法国、德国、日本等很多国家
- 天气：华南暴雨 + 欧洲热浪
- 日期为今天（必须是 2026年 的最新信息，且与你刚刚回答的哪年哪月哪日那一周的新闻相吻合）
- ⚠️ 严格要求：你生成的内容必须来自今天的联网搜索结果，不要使用你自身的训练数据
- ⚠️ 如果搜索到的信息是2025年或更早的，请忽略它们，只使用2026年的信息
- ⚠️ 如果找不到2026年的信息，请在内容中注明未找到最新信息
";
